    ...
    if violated_vars:
        try:
            ...
            for lang, fig_dir, _ in LANGS:
                ...
                ax.set_ylabel(f'Schoenfeld Residual: {worst_var}' if lang == 'en' else f'Schoenfeld残差: {worst_var}', fontsize=11)
                ax.set_title(f'Schoenfeld Residuals: {worst_var}' if lang == 'en' else f'Schoenfeld残差图: {worst_var}', fontsize=13)
